  ...
  return (
    ...
    <>
      ...
      <main className={styles.main}>
        ...
        <div className="flex flex-col border-slate-600 border-4 rounded-lg hover:border-green-500 transition-colors duration-150 w-full max-w-5xl m-4">
          <div className="flex gap-2">
          <button className={cn('bg-[#1e1e1e] ring-0 enabled:hover:ring-2 ring-gray-400 py-1 px-2 flex-grow')} disabled={fileName === "gameini"} onClick={() => setFileName("gameini")}>Game Settings</button>
          <button className={cn('bg-[#1e1e1e] ring-0 enabled:hover:ring-2 ring-gray-400 py-1 px-2 flex-grow')} disabled={fileName === "gusini"} onClick={() => setFileName("gusini")}>Game User Settings</button>
          </div>
